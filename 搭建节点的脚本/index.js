...
const UUID = process.env.UUID || '86920079-0ecb-401e-a598-ddcaed287699';  // 在不同的平台运行了v1哪吒请修改UUID,否则会覆盖
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'data234.lengleng123.kdns.fr';           // argo固定隧道域名,留空即使用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZmE5OGQ0NWU3ZjhkNTU1NDRiZmY5M2I5OWJkNzJlMDQiLCJ0IjoiODEzOGEwYWQtNGI2MC00YjYwLTk3OTktOTJjOTMxOTkxMDVjIiwicyI6Ik16YzBabVEzWlRNdE0yRTNOUzAwWVROa0xUbGhZak10WldOaU1EWmpORGsyTURWaSJ9';               // argo固定隧道token或json,留空即使用临时隧道
...
const NAME = process.env.NAME || 'wo';                         // 节点名称
